...
const site: DeepPartial<SiteConfig> = {
	site: "https://nbeara-blog.vercel.app",
	base: "/",
	title: "Asya",
	subtitle: "奇跡の始発点",
	lang: "zh_CN",
...
const profile: DeepPartial<ProfileConfig> = {
	...
	name: "NBeara",
	bio: "If nothing go right,go left.",
	links: [
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/NBeara",
		},
	],
};
...
// config/games.yaml
const games: DeepPartial<GamesConfig> = {
	enable: false,
	categories: [
		{
			key: "open-world",
